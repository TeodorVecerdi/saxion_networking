...
public static class Logger {
    ...
    public static void Except(Exception exception, bool includeStackTrace = false, bool includeFileInfo = false, bool includeTimestamp = true) {
        var message = exception.Message;
        if (includeStackTrace) message += $"\n{exception.StackTrace}";
        Error(message, "EXCEPTION", includeFileInfo, includeTimestamp);
    }

    public static void Info(object message, string messageTitle = "INFO", bool includeFileInfo = false, bool includeTimestamp = true) {
#if DEBUG
    ...
    public static void Warn(object message, string messageTitle = "WARN", bool includeFileInfo = false, bool includeTimestamp = true) {
#if DEBUG
        var fileInfo = includeFileInfo ? GetFileInfo() : "";
        messageTitle = includeTimestamp ? GetTitleWithDate(messageTitle) : messageTitle;
    ...
    public static void Error(object message, string messageTitle = "ERROR", bool includeFileInfo = false, bool includeTimestamp = true) {
#if DEBUG
        var fileInfo = includeFileInfo ? GetFileInfo() : "";
        messageTitle = includeTimestamp ? GetTitleWithDate(messageTitle) : messageTitle;
