...
public class ApplicationFSM : MonoBehaviour {
    ...
    private readonly Dictionary<Type, ApplicationState> stateMap = new Dictionary<Type, ApplicationState>();
    ...
    [SerializeField] private ApplicationState StartState;
    ...
    protected void Awake() {
        ...
        var states = GetComponentsInChildren<ApplicationState>(true);
    ...
    public void ChangeState(Type type) {
        ...
        if (type != null && stateMap.ContainsKey(type)) {
